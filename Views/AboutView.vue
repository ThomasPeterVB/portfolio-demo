<template>
  <div class="aboutcontainer">
    ...
    <div class="topright">
      ...
      <br><br>
      <p>I'm a Freelance full stack web and software developer from northern Sweden, currently building customer experience tools for a leading global music platform. I gained my first experience in the industry developing an MMORPG, and ran it from my bedroom for 4 years while attending highschool.</p>
      <br><br>
      <p>My passion for programming, or rather development as a whole, derives from a desire to create and improve, therefore my products are UX-centered, intuitive, and highly-optimised.</p>
    </div>
    <div class="bottomrow">
